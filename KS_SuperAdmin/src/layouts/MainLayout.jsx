...
import { getCurrentUser, logoutSuperAdmin, isAuthenticated, getStoredUser } from '../services/authService';
...
export default function MainLayout() {
  ...
  useEffect(() => {
    ...
    // Ambil data user dari localStorage untuk initial render
    const storedUser = getStoredUser();
    if (storedUser) {
      setUser(storedUser);
    }

    // Verifikasi token ke backend via service
    getCurrentUser()
      .then((userApi) => {
